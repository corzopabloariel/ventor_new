        ...
        <div class="card mt-2 border-0">
            <div class="card-body">
                <form action="{{ $form['url'] }}" method="get">
                    <div class="d-flex">
                        <input aria-label="Search" required pattern=".{1,}" value="{{$form['search']}}" placeholder="{{ $form['placeholder'] }}" type="search" class="form-control form-control-lg border-left-0 border-top-0 border-rigth-0 rounded-0" name="search"/>
