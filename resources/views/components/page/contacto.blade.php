        ...
        <div class="contacto__grid-hero section__holder">
            <div class="contacto__info">
                <div class="contacto__row">
                    ...
                    <div class="contacto__grid1 --contact">
                        ...
                        <a href="mailto:{{ $ventor->first_email }}" target="_blank" style="margin-top: 1em" class="contacto__contact__items --email">
                            <i class="contacto__contact__icon fas fa-envelope"></i>
                            <span class="contacto__contact__text">{{ $ventor->first_email }}</span>
                        </a>

                        <div class="contacto__contact__items --time" style="margin-top: 1em">
            ...
            <div class="contacto__form">
                <form action="{{ route('client.datos', ['section' => 'contacto']) }}" novalidate id="contactoForm" method="post">
                    <div class="form-item">
                        ...
                        <select name="mandar" id="mandar" class="select" style="margin-bottom: 0.625rem">
                            <option value="" selected hidden>Enviar a</option>
                            @foreach($numeros AS $n)
                                @if (!empty($n->email))
                                @php
                                $label = $n->name;
                                if (strlen($n->person) > 2) {
